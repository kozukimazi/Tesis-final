...
\insertimage[\label{img:fig4resultado}]{ejemplos/drawing1}{scale=0.70}{(a) Gráfico del flujo de energía, la razón de cambio de energía libre, contribución de información, potencia, flujo de calor del sistema LR. (b) Gráfico del flujo de energía, la razón de cambio de energía libre, contribución de información, potencia, flujo de calor del Demonio. }

El gráfico de la Figura \ref{img:fig4resultado} nos muestra primero que el flujo de energía en comparación a la contribución de la información es pequeña. Es así que en la zona en que el sistema $LR$ realiza trabajo, es decir $\dot{W}_{LR}<0$ y  $\dot{\mathcal{F}}_{LR}<0$, 
