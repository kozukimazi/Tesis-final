...
Es interesante percatarse que cuando $eV/T>4$ se tiene que el punto cuántico que entrega más información es $R$, mientras que para $eV/T<4$ el punto cuántico $L$ entrega más información. Esto se puede entender analizando las partes diagonales de la matriz densidad, para $eV/T<4$, $\rho_{001}>\rho_{100},\rho_{001}$ esto favorece que el punto cuántico $D$ este más lleno con respecto a $L$ y $R$, lo que según la dinámica favorece a que $D$ monitoree el sistema, ahora debido a que se favorece que $\rho_{100}$ este poblado, este entrega más información, ya que el punto cuántico $R$ requiere que $\rho_{101} sea grande$. Por otro lado para $eV/T>4$  $\rho_{001}<\rho_{100},\rho_{010}$ al estar más vacío el Demonio decrece la información monitoreada. 
\\
