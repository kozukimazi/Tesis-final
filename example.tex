...
En donde el cambio de entropía del sistema consiste en 
...
Tal que, cuando $I_{xy}$ es grande los dos sistemas son altamente correlacionados, mientras que $I_{xy}=0$ significa que los sistemas son estadísticamente independientes. Para definir los flujos de información, se necesita calcular la variación temporal de la información mutua $\partial_{t} I_{xy} = \dot{I}^{X} + \dot{I}^{Y}$ con
