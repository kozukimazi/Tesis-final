...
\insertimage[\label{img:transporte2}]{ejemplos/transportwork.png}{scale =0.35}{Gráfico de la potencia que entrega el reservorio conectado al sistema $LR$.}
    
La Figura \ref{img:transporte2} nos dice que el reservorio entrega trabajo al sistema para poder realizar la corriente, lo que tmabién es esperable, dado que al pasar de un potencial mayor a uno menor el electró
